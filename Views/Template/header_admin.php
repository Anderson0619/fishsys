...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Sistema Fishcorp S.A.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Anderson Mera">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Sistema Fishcorp</a>
